...
export class ServiceComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this._appservice.getAllSerice().subscribe((Response) => {
    ...
    getDetails(str: any) {
        ...
        this._appservice.getDetailService(str).subscribe((Response) => {
            if (Response.STATUSCODE == 4002) {
                this._message.showError(Response.message);
                localStorage.clear();
                location.reload();
    ...
    saveData() {
        ...
        if (this.edit == true && flag == 0) {
            if (this.item.title == '' || this.item.title == undefined) {
                ...
                this._appservice.editService(this.item, this.uploadfile)
                    .subscribe((Response) => {
                        if (Response.STATUSCODE == 4002) {
                            this._message.showError(Response.message);
                            localStorage.clear();
