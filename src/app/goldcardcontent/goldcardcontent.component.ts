...
@Component({
    selector: 'goldcardcontent',
    styleUrls: ['./goldcardcontent.component.css'],
    templateUrl: './goldcardcontent.component.html',
})
// class Select
export class GoldcardcontentComponent implements OnInit {
    edit: boolean;
    data: any;
    admintoken: any;
    pagetitle: any;
    ...
    getDetails(str: any) {
        this.edit = true;
        this.popupDiv = true;
        this.pagetitle = 'Edit Gold Card Content';
