...
@Component({
    selector: 'printcardcontent',
    styleUrls: ['./printcardcontent.component.css'],
    templateUrl: './printcardcontent.component.html',
})
// class Select
export class PrintcardcontentComponent implements OnInit {
    edit: boolean;
    data: any;
    admintoken: any;
    pagetitle: any;
    ...
    getDetails(str: any) {
        this.edit = true;
        this.popupDiv = true;
        this.pagetitle = 'Edit Print Card Content';
